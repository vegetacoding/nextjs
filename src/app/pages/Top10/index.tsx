        ...
        <div className="container mx-auto max-w-[1440px] h-full relative p-8 sm:p-16">
          <div className="flex items-center justify-center lg:hidden">
            <motion.h2
              ...
              className="text-[35px] sm:text-[45px] mb-11 text-center font-bold text-golden-gradient font-noto"
            >
              TOP 10 LÝ DO <br /> SỞ HỮU
            </motion.h2>
          </div>
          ...
          <div className="flex justify-between items-center gap-8">
            ...
            >
              <motion.h3
                ...
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="font-script text-[40px] sm:text-[55px] mb-4 text-white font-handwriting "
              >
                Đại lý phân phối
              </motion.h3>
              <motion.div
              ...
              >
                ...
                <h1 className="text-[35px] sm:text-[40px] font-bold text-golden-gradient mb-6">
                  THE OPUS ONE
                </h1>
              </motion.div>
