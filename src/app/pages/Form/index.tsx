...
export default function Form() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitGoogleSheet("thongtin", name, "", phone, product, "");
      setFormData({
        name: "",
        phone: "",
        product: "",
  ...
  return (
    <>
      <AnimatePresence>
        {showNotification && (
          <motion.div
            ...
            style={{
              background: "linear-gradient(to right, #152F68, #1E4B9B)",
            }}
          >
      ...
      >
        <div className="container mx-auto max-w-[1324px]">
          <motion.div
            ...
            className="bg-[#152F68] lg:rounded-lg py-8 px-6 lg:px-12 shadow-lg flex flex-col items-center"
          >
            <motion.h2
              initial={{ y: -20, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="text-xl lg:text-3xl font-bold text-golden-gradient text-center mb-2"
            >
            ...
            <motion.p
              ...
              className="text-white text-center text-xs lg:text-base mb-8 uppercase"
            >
            ...
            <div className="flex items-center justify-start">
              ...
              >
                <motion.div
                  ...
                  whileInView={{ y: 0, opacity: 1 }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="text-[12px] sm:text-[25px] xl:text-[40px] p-3 font-semibold font-noto bg-blue-gradient flex items-center justify-center"
                >
                  <span className="text-golden-gradient uppercase">
                    VÀNH ĐAI 3 HOÀN THÀNH
                  </span>
                ...
                <motion.div
                  ...
                  whileInView={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.6, delay: 0.3 }}
                  className="bg-white p-6 border-b-1 border-gray-300 text-blue-gradient font-semibold flex items-center justify-center gap-4"
                >
                  <div className="text-xl sm:text-2xl">31/12/2025</div>
                ...
                <motion.div
                  ...
                  whileInView={{ y: 0, opacity: 1 }}
                  transition={{ duration: 0.6, delay: 0.6 }}
                  className="text-[12px] sm:text-[25px] xl:text-[40px] font-semibold p-3 bg-blue-gradient flex items-center justify-center"
                >
                  <span className="text-golden-gradient uppercase text-center">
                    CƠ HỘI SỞ HỮU KHI VÀNH ĐAI ĐI VÀO HOẠT ĐỘNG CÓ TIỀM NĂNG GIA
                    TĂNG
                  </span>
                </motion.div>
              </motion.div>
      ...
      <section
        ...
        className="w-screen relative overflow-hidden bg-white md:pt-8 flex flex-col"
      >
        <div className="bg-white">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
